...
export const HW_SCAN_INTERVAL = 5000;
let instance = null;
...
export default class HardwareStore {
  ...
  _subscribeParity () {
    ...
    return this._api.pubsub
      .subscribeAndGetResult(
        ...
        hwInfo => {
          Object.keys(hwInfo).forEach(address => {
  ...
  scan () {
    ...
    return this.scanLedger().then(ledgerAccounts => {
  ...
  createAccountInfo (entry, original = {}) {
    ...
    return Promise.all([
      ...
      this._api.parity.setAccountMeta(
        address,
        Object.assign(
          {
